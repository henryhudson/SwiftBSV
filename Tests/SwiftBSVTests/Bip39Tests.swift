...
//        XCTAssertEqual(derrived.publicKey.address, "17rxURoF96VhmkcEGCj5LNQkmN9HVhWb7F")
    ...
    func testMenmonic() {
        ...
        let mnemonic2 = Bip39.create(entropy: entropy2)
        XCTAssertEqual(
            mnemonic2,
    ...
    func testSeedGeneration() {
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
    ...
    func testJapaneceGeneration() {
        let entropy = Data(hex: "000102030405060708090a0b0c0d0e0f")
        let mnemonic = Bip39.create(entropy: entropy, language: .japanese)
        let seed = Bip39.createSeed(mnemonic: mnemonic)
        XCTAssertEqual(
            seed.toHexString(),
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2, language: .japanese)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
    ...
    func testKoreanGeneration() {
        let entropy = Data(hex: "000102030405060708090a0b0c0d0e0f")
        let mnemonic = Bip39.create(entropy: entropy, language: .korean)
        let seed = Bip39.createSeed(mnemonic: mnemonic)
        XCTAssertEqual(
            seed.toHexString(),
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2, language: .korean)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
    ...
    func testFrenchGeneration() {
        let entropy = Data(hex: "000102030405060708090a0b0c0d0e0f")
        let mnemonic = Bip39.create(entropy: entropy, language: .french)
        let seed = Bip39.createSeed(mnemonic: mnemonic)
        XCTAssertEqual(
            seed.toHexString(),
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2, language: .french)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
    ...
    func testItalianGeneration() {
        let entropy = Data(hex: "000102030405060708090a0b0c0d0e0f")
        let mnemonic = Bip39.create(entropy: entropy, language: .italian)
        let seed = Bip39.createSeed(mnemonic: mnemonic)
        XCTAssertEqual(
            seed.toHexString(),
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2, language: .italian)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
    ...
    func testSimplifiedChineseGeneration() {
        let entropy = Data(hex: "000102030405060708090a0b0c0d0e0f")
        let mnemonic = Bip39.create(entropy: entropy, language: .simplifiedChinese)
        let seed = Bip39.createSeed(mnemonic: mnemonic)
        XCTAssertEqual(
            seed.toHexString(),
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2, language: .simplifiedChinese)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
    ...
    func testTraditionalChineseGeneration() {
        let entropy = Data(hex: "000102030405060708090a0b0c0d0e0f")
        let mnemonic = Bip39.create(entropy: entropy, language: .traditionalChinese)
        let seed = Bip39.createSeed(mnemonic: mnemonic)
        XCTAssertEqual(
            seed.toHexString(),
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2, language: .traditionalChinese)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
    ...
    func testSpanishGeneration() {
        let entropy = Data(hex: "000102030405060708090a0b0c0d0e0f")
        let mnemonic = Bip39.create(entropy: entropy, language: .spanish)
        let seed = Bip39.createSeed(mnemonic: mnemonic)
        XCTAssertEqual(
            seed.toHexString(),
        ...
        let entropy2 = Data(hex: "a26a4821e36c7f7dccaa5484c080cefa")
        let mnemonic2 = Bip39.create(entropy: entropy2, language: .spanish)
        let seed2 = Bip39.createSeed(mnemonic: mnemonic2)
        XCTAssertEqual(
            seed2.toHexString(),
